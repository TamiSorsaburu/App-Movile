...
public class SolicitarTurnoServicio extends AppCompatActivity {
    private CalendarView calendarView;
    private TextView servicioTurno,txtHoraSeleccionada, btnHora, fechaTurnoTextView, serviciosSeleccionados, fechaTurno, horaTurno, precioTurno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solicitar_turno_servicios);
        servicioTurno=findViewById(R.id.servicioTurno);
        ...
        btnHora.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(SolicitarTurnoServicio.this,
